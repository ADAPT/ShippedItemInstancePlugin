...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentReferenceListRequestEntry : IEquatable<ShipmentReferenceListRequestEntry>
    { 
        /// <summary>
        /// shipment identifier created by the retailer ERP system
        /// </summary>
        /// <value>shipment identifier created by the retailer ERP system</value>
        ...
        /// <summary>
        /// Line Identifier on the delivery document the shipped item appears.   This could be a concatenation of the shipment identifier and a line identifier to guarantee uniqueness within this document.
        /// </summary>
        /// <value>Line Identifier on the delivery document the shipped item appears.   This could be a concatenation of the shipment identifier and a line identifier to guarantee uniqueness within this document.</value>
        ...
        /// <summary>
        /// Timestamp that the Farmer picked up the shipment at the Retailer - - if so Carrier Party is either not present or the name of the driver that picked up the shipment.  If Pickup then ActualShipmentDateTime and ActualDeliverDateTime are null.
        /// </summary>
        /// <value>Timestamp that the Farmer picked up the shipment at the Retailer - - if so Carrier Party is either not present or the name of the driver that picked up the shipment.  If Pickup then ActualShipmentDateTime and ActualDeliverDateTime are null.</value>

        [DataMember(Name="actualPickupDateTime")]
        public DateTime? ActualPickupDateTime { get; set; }

        /// <summary>
        /// Actual date the Retailer&#x27;s fleet or contractor truck left the retailer&#x27;s warehouse, departing to the farm.  
        /// </summary>
        /// <value>Actual date the Retailer&#x27;s fleet or contractor truck left the retailer&#x27;s warehouse, departing to the farm.  </value>

        [DataMember(Name="actualShipDateTime")]
        public DateTime? ActualShipDateTime { get; set; }

        /// <summary>
        /// Timestamp that the Farmer received the shipment at the Farm Location - - if so Carrier Party is the name of the driver that delivered the shipment. If Delivery, then ActualShipDateTime is present, and ActualPickupDateTime is null.
        /// </summary>
        /// <value>Timestamp that the Farmer received the shipment at the Farm Location - - if so Carrier Party is the name of the driver that delivered the shipment. If Delivery, then ActualShipDateTime is present, and ActualPickupDateTime is null.</value>
        ...
        public ShipmentReferenceAcceptedQuantity AcceptedQuantity { get; set; }
        ...
        public ShipmentReferenceRejectedQuantity RejectedQuantity { get; set; }
        ...
        public ShipmentReferenceReturnedQuantity ReturnedQuantity { get; set; }

        /// <summary>
        /// RMA identifier issued by the retailer authorizing the return of the rejected quantity back to the retailer&#x27;s warehouse.
        /// </summary>
        /// <value>RMA identifier issued by the retailer authorizing the return of the rejected quantity back to the retailer&#x27;s warehouse.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentReferenceListRequestEntry {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ShipmentReferenceListRequestEntry)obj);
        }

        /// <summary>
        /// Returns true if ShipmentReferenceListRequestEntry instances are equal
        /// </summary>
        /// <param name="other">Instance of ShipmentReferenceListRequestEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentReferenceListRequestEntry other)
        {
        ...
        public static bool operator ==(ShipmentReferenceListRequestEntry left, ShipmentReferenceListRequestEntry right)
        {
