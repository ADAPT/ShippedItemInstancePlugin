...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelatedId : IEquatable<RelatedId>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RelatedId)obj);
        }

        /// <summary>
        /// Returns true if RelatedId instances are equal
        /// </summary>
        /// <param name="other">Instance of RelatedId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedId other)
        {
        ...
        public static bool operator ==(RelatedId left, RelatedId right)
        {
