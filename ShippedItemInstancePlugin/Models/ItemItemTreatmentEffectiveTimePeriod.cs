...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemItemTreatmentEffectiveTimePeriod : IEquatable<ItemItemTreatmentEffectiveTimePeriod>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemItemTreatmentEffectiveTimePeriod {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ItemItemTreatmentEffectiveTimePeriod)obj);
        }

        /// <summary>
        /// Returns true if ItemItemTreatmentEffectiveTimePeriod instances are equal
        /// </summary>
        /// <param name="other">Instance of ItemItemTreatmentEffectiveTimePeriod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemItemTreatmentEffectiveTimePeriod other)
        {
        ...
        public static bool operator ==(ItemItemTreatmentEffectiveTimePeriod left, ItemItemTreatmentEffectiveTimePeriod right)
        {
