...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentReferenceListResponse : List<ShipmentReferenceListResponseEntry>, IEquatable<ShipmentReferenceListResponse>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentReferenceListResponse {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ShipmentReferenceListResponse)obj);
        }

        /// <summary>
        /// Returns true if ShipmentReferenceListResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ShipmentReferenceListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentReferenceListResponse other)
        {
        ...
        public static bool operator ==(ShipmentReferenceListResponse left, ShipmentReferenceListResponse right)
        {
