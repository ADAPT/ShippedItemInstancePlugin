...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ShipmentReferenceListRequest : List<ShipmentReferenceListRequestEntry>, IEquatable<ShipmentReferenceListRequest>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentReferenceListRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ShipmentReferenceListRequest)obj);
        }

        /// <summary>
        /// Returns true if ShipmentReferenceListRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ShipmentReferenceListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentReferenceListRequest other)
        {
        ...
        public static bool operator ==(ShipmentReferenceListRequest left, ShipmentReferenceListRequest right)
        {
