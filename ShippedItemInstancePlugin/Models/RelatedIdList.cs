...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelatedIdList : List<RelatedId>, IEquatable<RelatedIdList>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RelatedIdList)obj);
        }

        /// <summary>
        /// Returns true if RelatedIdList instances are equal
        /// </summary>
        /// <param name="other">Instance of RelatedIdList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedIdList other)
        {
        ...
        public static bool operator ==(RelatedIdList left, RelatedIdList right)
        {
