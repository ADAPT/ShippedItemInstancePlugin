...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeasurementList : List<Measurement>, IEquatable<MeasurementList>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeasurementList {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MeasurementList)obj);
        }

        /// <summary>
        /// Returns true if MeasurementList instances are equal
        /// </summary>
        /// <param name="other">Instance of MeasurementList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementList other)
        {
        ...
        public static bool operator ==(MeasurementList left, MeasurementList right)
        {
