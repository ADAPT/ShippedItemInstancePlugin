...
{
    /// <summary>
    /// Number of seed bags or quantity of other product if crop protection
    /// </summary>
    [DataContract]
    public partial class ShippedItemInstanceQuantity : IEquatable<ShippedItemInstanceQuantity>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShippedItemInstanceQuantity {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ShippedItemInstanceQuantity)obj);
        }

        /// <summary>
        /// Returns true if ShippedItemInstanceQuantity instances are equal
        /// </summary>
        /// <param name="other">Instance of ShippedItemInstanceQuantity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShippedItemInstanceQuantity other)
        {
        ...
        public static bool operator ==(ShippedItemInstanceQuantity left, ShippedItemInstanceQuantity right)
        {
