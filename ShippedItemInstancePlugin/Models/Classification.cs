...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Classification : IEquatable<Classification>
    { 
        /// <summary>
        /// Type of classification
        /// </summary>
        /// <value>Type of classification</value>
        ...
        public ClassificationCodes Codes { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Classification)obj);
        }

        /// <summary>
        /// Returns true if Classification instances are equal
        /// </summary>
        /// <param name="other">Instance of Classification to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Codes != null)
                    hashCode = hashCode * 59 + Codes.GetHashCode();
                return hashCode;
            }
        }
